...
public interface EnrollmentAPI {
    @Operation(
            ...
            parameters = {
                    ...
                    @Parameter(
                            name = "sortBy", required = true, in = ParameterIn.QUERY, example = "firstName",
                    ...
                    @Parameter(
                            name = "ip-address", required = false, in = ParameterIn.HEADER,
            ...
            responses = {
                    @ApiResponse(responseCode = "201", description = "success", content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = EnrollmentResponse.class))}),
